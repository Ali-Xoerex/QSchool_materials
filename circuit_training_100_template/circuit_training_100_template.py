...
def optimize_circuit(params):
    ...
    def cost_function(circ,p):
        return circ(p)
    # optimize    
    for i in range(epoches):
        params = optimizer.step(cost_function,circuit,params)
        params = params[1]
        current_cost = cost_function(circuit,params)
        #print("Epoch: {}\nCost:{}".format(i+1,current_cost))

    optimal_value = cost_function(circuit,params)
    # QHACK #
